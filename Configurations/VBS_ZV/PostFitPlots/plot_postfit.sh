...
PLOTVAR=DNNoutput_pruned_bVeto
#DYfit_2D_bin_Resolved 
...
#DNNoutput_pruned_bReq #for top cr and sr
            ...
            ## choose a cut name for output folder, not really relevant for the plotting as it reads the datacard we are interested in 
...
cp ${DATACARD_PLOT}.txt datacard.txt
echo "datacard we want to plot: ${DATACARD_PLOT}"
text2workspace.py datacard.txt -o plotWorkspace.root         ### this is the plotting workspace
...
mkPostFitCombinedPlot.py \
    ...
    --cutName combinedMy \
    --variable ${PLOTVAR} \
    --structureFile ../2018_Apr22/structure.py \
    --plotFile ../2018_Apr22/plot_DY.py \
    --lumiText '${lumi}/fb' 
