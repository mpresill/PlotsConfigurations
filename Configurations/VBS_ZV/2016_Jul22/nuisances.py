...
mc_common = ["DY", "top", "WJets", "WW", "ggWW", "Vg", "VgS", "VZ", "VVV","tZq", "VBF-V"] #"VBF-V", missing
...
nuisances['lumi_Uncorrelated'] = {
    ...
    'type': 'lnN',
    'samples': dict((skey, '1.01') for skey in mc if skey not in ['top', 'DY'])
}
...
nuisances['QCDscale_ewk_ZV_accept'] = {
            ...
            'kind'  : 'weight',
            'type'  : 'shape',
            'samples'  :  { "VBS_ZV": ["QCDscale_normalized[0]", "QCDscale_normalized[8]"] },
            'AsLnN': '1'    ##
...
nuisances['pdf_ewk_ZV_accept'] = {
    ...
    'kind'  : 'weight_envelope',
    'type'  : 'shape',
    'samples': { k : [ 'Alt$(PDFweight_normalized['+str(i)+'], 1.)' for i in range(0,103) ] for k in ["VBS_ZV"]},
    'AsLnN': '1'    ##
}
...
apply_on = {
    'top': [
        '(topGenPt * antitopGenPt <= 0.) * 1.0816 + isTTbar)',
        '(topGenPt * antitopGenPt <= 0.) * 0.9184 + isTTbar)'
    ]
}
"""
