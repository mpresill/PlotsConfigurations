...
aliases['mZV'] = {
    ...
    'class': 'jets_cat_dnn_FJ',
    'args': ('mZV','2017', models_path,models_path_pruned, False)
}
...
models_path_pruned_bVeto = '%s/Configurations/VBS_ZV/Models/Sep22/2017_bVeto_pruned' % configurations
models_path_pruned_bReq = '%s/Configurations/VBS_ZV/Models/Sep22/2017_bReq_pruned' % configurations
