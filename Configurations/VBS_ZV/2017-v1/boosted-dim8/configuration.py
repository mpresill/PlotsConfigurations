...
samplesFile = 'samples_'+categ+'-dim8.py' #when launching
#samplesFile = 'samples.py' #after adding


# file with list of samples
plotFile = '../plot-dim8.py' #this is the updated version for postfit plotting without hacks
