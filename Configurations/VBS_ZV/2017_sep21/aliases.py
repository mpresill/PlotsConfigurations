...
#nobtag sf test
aliases['SFweight'] = {
    'expr': ' * '.join(['SFweight2l', 'LepSF2l__ele_' + eleWP + '__mu_' + muWP,'PrefireWeight', 'LepWPCut','PUJetIdSF', 'btagSF' ]),
    'samples': mc
}
# variations
...
models_path_pruned = '/eos/home-a/ahakimi/www/ZV_analysis/Models/full_SR'
