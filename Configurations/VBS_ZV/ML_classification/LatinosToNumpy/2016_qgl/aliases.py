...
"""
morph_file = "/afs/cern.ch/work/m/mpresill/Latino/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/VBS_ZV/qgl_16/Remorphing/morphing_functions_comb.root"
do_morph = "11111111"
...
aliases['cat']={
    'expr': "jets_cat(nCleanJetNotFat, nCleanFatJet, CleanJet_pt, CleanJetNotFat_jetIdx, CleanJet_phi, CleanJet_eta, Jet_mass, CleanJet_jetIdx, CleanFatJet_mass,nLepton, Lepton_eta, CleanFatJet_eta, Jet_qgl, CleanFatJet_jetIdx, Jet_btagDeepB, Lepton_pt, Lepton_phi,2016,Jet_partonFlavour,\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\")".format( morph_file, do_morph,m_gluon_loweta_pt0, m_gluon_loweta_pt1, m_gluon_higheta_pt0, m_gluon_higheta_pt1,m_quark_loweta_pt0, m_quark_loweta_pt1, m_quark_higheta_pt0, m_quark_higheta_pt1) ,
    }
...
aliases['vbs_jet_1_qgl_morphed'] = {'expr':"cat[25]"}
aliases['vbs_jet_2_qgl_morphed'] = {'expr':"cat[26]"}
aliases['v_jet_1_qgl_morphed'] = {'expr':"cat[27]"}
aliases['v_jet_2_qgl_morphed'] = {'expr':"cat[28]"}
...
aliases['PUJetIdSF'] = {
    'expr' : 'PUJetIdEventSF("/afs/cern.ch/work/m/mpresill/Latino/CMSSW_10_6_4/src/PlotsConfigurations/Configurations/patches/PUID_81XTraining_EffSFandUncties.root", "2016", "loose", nJet, nLepton, Lepton_eta, Lepton_phi, Jet_pt, Jet_eta, Jet_phi, Jet_jetId, Jet_genJetIdx, Jet_puId)',
    'samples': mc
}
