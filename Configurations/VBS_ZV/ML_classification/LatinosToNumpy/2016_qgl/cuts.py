...
#######################################
cuts['Boosted_SR'] = {
    'expr': 'category==0 && nCleanFatJet == 1 &&  (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && V_jet_mass > 65. && V_jet_mass < 105 ',
    'parent' : 'supercut',
    'doVars' : True,
    'doNumpy': True
    }

cuts['Boosted_SR_bVeto'] = {
...
cuts['Boosted_SR_bReq'] = {
    'expr': 'category==0 && nCleanFatJet == 1 &&  (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && V_jet_mass >65. && V_jet_mass < 105 && bReq',
    'parent' : 'supercut',
    'doVars' : True,
    'doNumpy': True
    }
...
cuts['Resolved_SR_bReq'] = {
    'expr': 'category==1  && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && V_jet_mass >65. && V_jet_mass < 105 && bReq ',
    'parent' : 'supercut',
    'doVars' : True,
    'doNumpy': True
    }
...
cuts['Resolved_DYcr_bReq']  = {
        'expr' : 'category==1 && bReq && ( V_jet_mass<65 || V_jet_mass>105) && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13)',
  'parent' : 'supercut',
    'doVars' : True,
    'doNumpy': True
