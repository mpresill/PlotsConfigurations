...
### T1
quadReweight_cT0 = '( 0.5* (1/(1)) * (1/(1)) * ( LHEReweightingWeight[951] + LHEReweightingWeight[911] - 2 * LHEReweightingWeight[931]))'
LinReweight_cT0 = '( 0.5* (1/(1)) * ( LHEReweightingWeight[951] - LHEReweightingWeight[911] ))'
sm_cT0 = '( LHEReweightingWeight[931] )'
LinQuadReweight_cT0 = '(' +  quadReweight_cT0 + '+' + LinReweight_cT0 + ')'
smLinQuadReweight_cT0 = '(' + sm_cT0 + '+' +  quadReweight_cT0 + '+' + LinReweight_cT0 + ')'
### T2
...
addSampleWeight(samples,'sm_lin_quad_cT3','ZTo2L_ZTo2J_aQGC_eboliv2_official',                                       smLinQuadReweight_cT0)
addSampleWeight(samples,'sm_lin_quad_cT3','WmTo2J_ZTo2L_aQGC_eboliv2_official','(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smLinQuadReweight_cT0)
addSampleWeight(samples,'sm_lin_quad_cT3','WpTo2J_ZTo2L_aQGC_eboliv2_official','(Sum$(abs(GenPart_pdgId)==6)==0) *'+ smLinQuadReweight_cT0)
 #*******************#      quadratic only
samples['quad_cT3'] = {
    'name':   nanoGetSampleFiles(DirectorySMPeos, 'ZTo2L_ZTo2J_aQGC_eboliv2_official') 
             +nanoGetSampleFiles(DirectorySMPeos, 'WmTo2J_ZTo2L_aQGC_eboliv2_official') 
...
addSampleWeight(samples,'quad_cT3','ZTo2L_ZTo2J_aQGC_eboliv2_official',                                       quadReweight_cT0)
addSampleWeight(samples,'quad_cT3','WmTo2J_ZTo2L_aQGC_eboliv2_official','(Sum$(abs(GenPart_pdgId)==6)==0) *'+ quadReweight_cT0)
addSampleWeight(samples,'quad_cT3','WpTo2J_ZTo2L_aQGC_eboliv2_official','(Sum$(abs(GenPart_pdgId)==6)==0) *'+ quadReweight_cT0)
