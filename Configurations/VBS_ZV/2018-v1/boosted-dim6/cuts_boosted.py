...
##############with cuts on DNN
#cuts['Boosted_SR_bVeto_DNN']  = 'DNNoutput_pruned_bVeto>0.5 && bVeto && nCleanFatJet==1 && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Vjet_mass > 65 && Vjet_mass <105'
#
#cuts['Boosted_SR_bTag_DNN']  = 'DNNoutput_pruned_bReq>0.5 && bReq && nCleanFatJet==1 && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Vjet_mass > 65 && Vjet_mass <105'
