...
models_path_pruned_bReq = '%s/Configurations/VBS_ZV/Models/Sep22/2017_bReq_pruned' % configurations #'/eos/user/m/mpresill/CMS/VBS/VBS_ZV/AlexandreBackup/Models/Models_github/DNN_training/models/Sep22/2017_bReq_pruned'
