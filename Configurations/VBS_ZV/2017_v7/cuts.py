...
cuts['Boosted_SR_tight']  = 'vbs_category==0 && bVeto && nCleanFatJet==1 && Vjet_mass > 65 && Vjet_mass<105  && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Lepton_pt[0]>40.&& fabs(Alt$(CleanJet_pt[vbs_jet_0],-9999.))>80. && mjj_max>350'
...
cuts['Resolved_SR_tight']  = 'vbs_category==1 && bVeto && Vjet_mass >65 && Vjet_mass<105 && (Lepton_pdgId[0]*Lepton_pdgId[1] == -11*11 || Lepton_pdgId[0]*Lepton_pdgId[1] == -13*13) && Lepton_pt[0]>40. && fabs(Alt$(CleanJet_pt[vbs_jet_0],-9999.))>80. && mjj_max>350 '
