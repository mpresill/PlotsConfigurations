...
variables['DYfit_bin_Resolved'] ={  'name' : 'fit_bin_Resolved',
                            'range' : (10,1,11),
                            'xaxis' : 'fitting variable Resolved', 
                            'fold' : 0,
                            'cuts': resolved_cuts
}  

variables['DYfit_bin_Boosted'] ={  'name' : 'fit_bin_Boosted',
                            'range' : (5,1,6),
                            'xaxis' : 'fitting variable Boosted', 
                            'fold' : 0,
                            'cuts': boosted_cuts
}  


#variables['DYbin_Boosted'] = { 'name' : 'Alt$(Zleppt, -999)',
...
#
#
#variables['DYbin_Resolved'] = { 'name' : 'Alt$(Zleppt, -999)',
#			'range' : (20,0.,800),
#			'xaxis' : 'p_{T} leptonic Z [GeV]',
#			'fold' : 3,
#      'cuts':  resolved_cuts,
...
variables['mjj_max_Resolved']  = {   'name': 'mjj_max',            #   variable name    
