...
for DYbin in range(1,13):
        nuisances["DY_Resolved_2d_{}_norm_res_Z_bVeto_2017".format(DYbin)]  = {
                ...
                'samples'  : {DY_bins_res[DYbin-1]:res_bVeto_2017[DYbin-1]},
                'type'  : 'rateParam',
                'cuts'  : [
                   'Resolved_DYcr_bVeto',
                   'Resolved_SR_bVeto',
        ...
        nuisances["DY_Resolved_2d_{}_norm_res_Z_bTag_2017".format(DYbin)]  = {
                ...
                'samples'  : {DY_bins_res[DYbin-1]:res_bTag_2017[DYbin-1]},
                'type'  : 'rateParam',
                'cuts'  : [
                   'Resolved_DYcr_bTag',
                   'Resolved_SR_bTag',
...
for DYbin in range(1,6):
        nuisances["DY_Boosted_Z_{}_norm_boost_Z_bVeto_2017".format(DYbin)]  = {
                ...
                'samples'  : {DY_bins_boos[DYbin-1]:boos_bVeto_2017[DYbin-1]},
                'type'  : 'rateParam',
                'cuts'  : [
                   'Boosted_DYcr_bVeto',
                   'Boosted_SR_bVeto',
        ...
        nuisances["{}_norm_boost_Z_bTag_2017".format(DYbin)]  = {
           ...
           'samples'  : {DY_bins_boos[DYbin-1]:boos_bTag_2017[DYbin-1]},
           'type'  : 'rateParam',
           'cuts'  : [
              'Boosted_DYcr_bTag',
              'Boosted_SR_bTag',
