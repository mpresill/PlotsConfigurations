...
DY_bins = ["DY_Resolved_2d_"+str(ir) for ir in ['01', '02', '03', '04', '05', '06', '07', '08', '09', '10', '11', '12']] + ["DY_Boosted_Z_"+str(ir) for ir in range(1,6)] + ["DY_Boosted_Z_bin"+str(ir) for ir in range(1,6)] + ["DY_bin"+str(ir) for ir in range(1,6)] 
...
groupPlot['Vg+VgS']  = {
                  'nameHR' : "V#gamma+V#gamma*+WJets",
                  'isSignal' : 0,
                  'color'    : palette['LightBlue'],   # kOrange - 3
                  'samples'  : ['Vg','VgS','WJets'],
                  'fill': 1001
              }
