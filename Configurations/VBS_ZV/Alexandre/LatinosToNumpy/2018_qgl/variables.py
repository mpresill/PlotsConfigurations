...
variables['vbs_jet_qgl1_morphed'] = {   'name': 'vbs_jet_1_qgl_morphed',
                        'range' : (40,-1.5,1.5),
                        }
variables['vbs_jet_qgl2_morphed'] = {   'name': 'vbs_jet_2_qgl_morphed',
                        'range' : (40,-1.5,1.5),
                        }
variables['V_jet_qgl1_morphed'] = {   'name': 'v_jet_1_qgl_morphed',
                        'range' : (40,-1.5,1.5),
                        }
variables['V_jet_qgl2_morphed'] = {   'name': 'v_jet_2_qgl_morphed',
                        'range' : (40,-1.5,1.5),
                        }


"""
variables['vbs_jet_pf1'] = {   'name': 'vbs_jet_pf1',
                        'range' : (40,-1.5,1.5),
                        }
variables['vbs_jet_pf2'] = {   'name': 'vbs_jet_pf2',
                        'range' : (40,-1.5,1.5),
                        }
variables['V_jet_pf1'] = {   'name': 'V_jet_pf1',
                        'range' : (40,-1.5,1.5),
                        }
variables['V_jet_pf2'] = {   'name': 'V_jet_pf2',
                        'range' : (40,-1.5,1.5),
                        }
"""
