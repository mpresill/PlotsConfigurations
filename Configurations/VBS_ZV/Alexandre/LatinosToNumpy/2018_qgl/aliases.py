...
morph_file = "/afs/cern.ch/work/a/ahakimi/latinos_NN/PlotsConfigurations/Configurations/VBS_ZV/qgl_18/Remorphing/morphing_functions_comb.root"
do_morph = "11111111"
...
aliases['cat']={
    'expr': "jets_cat(nCleanJetNotFat, nCleanFatJet, CleanJet_pt, CleanJetNotFat_jetIdx, CleanJet_phi, CleanJet_eta, Jet_mass, CleanJet_jetIdx, CleanFatJet_mass,nLepton, Lepton_eta, CleanFatJet_eta, Jet_qgl, CleanFatJet_jetIdx, Jet_btagDeepB, Lepton_pt, Lepton_phi,2018,Jet_partonFlavour,\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\",\"{}\")".format( morph_file, do_morph,m_gluon_loweta_pt0, m_gluon_loweta_pt1, m_gluon_higheta_pt0, m_gluon_higheta_pt1,m_quark_loweta_pt0, m_quark_loweta_pt1, m_quark_higheta_pt0, m_quark_higheta_pt1) ,
    }
