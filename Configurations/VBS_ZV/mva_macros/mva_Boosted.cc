...
#ifndef MVAREADERBoosted_v70_H
#define MVAREADERBoosted_v70_H

typedef TTreeReaderValue<Double_t> DoubleValueReader;

class MVAReaderBoosted_v70 : public multidraw::TTreeFunction {
public:
  
  MVAReaderBoosted_v70(const char* model_path, bool verbose, int category);

  char const* getName() const override { return "MVAReaderBoosted_v70"; }
  TTreeFunction* clone() const override { return new MVAReaderBoosted_v70(model_path_.c_str(), verbose, category_); }
...
MVAReaderBoosted_v70::MVAReaderBoosted_v70(const char* model_path, bool verbose, int category):
...
double
MVAReaderBoosted_v70::evaluate(unsigned)
{
  // Run only if 
...
void
MVAReaderBoosted_v70::bindTree_(multidraw::FunctionLibrary& _library)
{  
