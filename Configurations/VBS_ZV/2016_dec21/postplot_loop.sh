...
mkdir Workspace/${CUT}
cardName=${CUT}
for PLOTVAR in VBS_jet_pt1 VBS_jet_pt2 V_jet_pt1 V_jet_pt2 Zleppt detajj mjj VBS_jet_qgl1_morphed VBS_jet_qgl2_morphed V_jet_qgl1_morphed V_jet_qgl2_morphed 
do
