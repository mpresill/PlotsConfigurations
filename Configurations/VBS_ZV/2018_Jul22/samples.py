...
addSampleWeight(samples,'VBS_ZV','ZTo2L_ZTo2J_dipoleRecoil','(Sum$(abs(GenPart_pdgId)==6)==0)  * (0.01606/0.01589)')
addSampleWeight(samples,'VBS_ZV','WmTo2J_ZTo2L_dipoleRecoil','(Sum$(abs(GenPart_pdgId)==6)==0)  * (0.03004/0.02982)')
addSampleWeight(samples,'VBS_ZV','WpTo2J_ZTo2L_dipoleRecoil','(Sum$(abs(GenPart_pdgId)==6)==0) * (0.05526/0.05401)')
...
samples['VBS_VV_QCD'] = {
    'name':   nanoGetSampleFiles(DirectorySMPeos, 'WpToLNu_ZTo2J_QCD') 
             ...
             +nanoGetSampleFiles(DirectorySMPeos, 'ZTo2L_ZTo2J_QCD')              	 +nanoGetSampleFiles(DirectorySMPeos, 'WmTo2J_ZTo2L_QCD'),
    'weight':  mcCommonWeight,
    'FilesPerJob': 5
}
...
#here M-10to50-LO_ext1 are available
	...
	'subsamples' :{
		...
		#"R_bin3" : '(vbs_category == 1) && (Zleppt > 200 && Zleppt <=300)',
           ...
           #"Resolved_vbs1_1": 'fit_Z_vbs1_bin_Resolved==1',
           #"Resolved_vbs1_2": 'fit_Z_vbs1_bin_Resolved==2',
           #"Resolved_vbs1_3": 'fit_Z_vbs1_bin_Resolved==3',
           #"Resolved_vbs1_4": 'fit_Z_vbs1_bin_Resolved==4',
           #"Resolved_vbs1_5": 'fit_Z_vbs1_bin_Resolved==5',
           #"Resolved_vbs1_6": 'fit_Z_vbs1_bin_Resolved==6',
