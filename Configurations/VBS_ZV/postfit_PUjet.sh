...
folder=2018_PUjet
cd ${folder}
date=24June2021_2018bin_PUjet


declare -a StringArray=("Zleppt" "VBS_jet_pt1" "VBS_jet_pt2" "mjj_max" "detajj_mjjmax" )        #looping
for val in "${StringArray[@]}"; do                                                              #looping


#  fitting variable: in PUjet splitting we just use "events" for extracting the normalization in two different phase spaces
VAR1=events
CUT1=Resolved_DYcr_bVeto_lowDetajj
CUT_1=Resolved_DYcr_bVeto_highDetajj
DATACARD_FIT=Datacards/_${date}/${CUT1}/${VAR1}/datacard
DATACARD_FIT_1=Datacards/_${date}/${CUT_1}/${VAR1}/datacard
echo "${DATACARD_FIT}"
echo "${DATACARD_FIT_1}"

#  plotting variable 
PLOTVAR=${val} #PLOTVAR=VBS_jet_pt1
...
#text2workspace.py ${DATACARD_FIT_1}.txt -o ${DATACARD_FIT_1}.root
