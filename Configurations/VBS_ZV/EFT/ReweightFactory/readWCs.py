...
filename = 'InputCards_aQGC_WMhadZlepJJ/aQGC_WMhadZlepJJ_EWK_LO_SM_mjj100_pTj10_reweight_card.dat'
#filename = 'InputCards_aQGC_ZlepZhadJJ/aQGC_ZlepZhadJJ_EWK_LO_SM_mjj100_pTj10_reweight_card.dat'
op='FT0'
WC=2
