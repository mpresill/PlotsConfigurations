...
if useDYtt:
	...
	'subsamples' :{
           ...
           "Boosted_Z_bin1" : '(vbs_category == 0) && (Zleppt > 0 && Zleppt <=75)',
           "Boosted_Z_bin2" : '(vbs_category == 0) && (Zleppt > 75 && Zleppt <=150)',
           "Boosted_Z_bin3" : '(vbs_category == 0) && (Zleppt > 150 && Zleppt <=250)',
           "Boosted_Z_bin4" : '(vbs_category == 0) && (Zleppt > 250 && Zleppt <=400)',
           "Boosted_Z_bin5" : '(vbs_category == 0) && (Zleppt > 400)',	
	},
        'EventsPerJob' : 70000,
