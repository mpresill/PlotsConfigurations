...
combine -M FitDiagnostics ${cardNameWorkspace}.root --out fit/${CAT}/${VAR2} --robustFit=1 --cminDefaultMinimizerStrategy 0 --rMin -10 --saveWithUncertainties --saveOverallShapes --plots --saveNormalizations -t -1 --expectSignal 0 --toysFreq  #--setParameters mask_${CUTSR}_${VAR2}=1 --toysFile  fit/toys_${VAR2}.root #--toysFreq --expectSignal 0 --robustFit=1
#cd Datacards_${date}
