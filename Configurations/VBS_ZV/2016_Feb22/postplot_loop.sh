...
mkdir Workspace/${CUT}
cardName=${CUT}
for PLOTVAR in VBS_jet_pt1 VBS_jet_pt2 V_jet_pt1 V_jet_pt2 Zleppt DYfit_Z_bin detajj_mjjmax mjj_max VBS_jet_qgl1_morphed VBS_jet_qgl2_morphed V_jet_qgl1_morphed V_jet_qgl2_morphed DNNoutput_full_bVeto DNNoutput_pruned_bVeto DNNoutput_pruned_bReq 
do
...
python $CMSSW_BASE/src/HiggsAnalysis/CombinedLimit/test/mlfitNormsToText.py fit/${CAT}/${FITVAR}/fitDiagnostics.root > postfit_${CUT}_${FITVAR}fit/norm.txt
