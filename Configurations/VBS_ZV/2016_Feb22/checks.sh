...
combine -M FitDiagnostics -d ${cardNameWorkspace}.root -t -1 --expectSignal 1 --rMin -10 --forceRecreateNLL -n _t1
...
combineTool.py -M Impacts -d ${cardNameWorkspace}.root -o ${outputFolder}/impacts_t0.json -t -1 --expectSignal 1 --rMin -10 --doFits -m 1 -n t1 
