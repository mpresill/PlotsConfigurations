#how to use EFT samples produced with reweigthing in CMS:


#LHEReweightingWeight vector of approx 99 elements,
# each of them corresponds to a weight that must be used to obtain predictions (i.e. histograms)
# for a specific Wilson Coefficient value of a specific operator (depending on the cards of the original gridpack) 

#in the following some examples

#usually the default value for "anoinput" 12 (FT1) is 2 TeV-4 --> no weighting for this value of the coefficient
...
EFT_operator = {
  "FS0":{
    "anoInput_number": 1, ##primo operatore in ordine 
    "idx": 1,
    "name": "FS0",
    "max": 25, #TeV^-4, 2.5 e-11 GeV^-4 
  },
  "FS1":{
    "anoInput_number": 2,  ### secondo operatore in ordine 
    "idx": 2,
    "name": "FS1",
