...
folder=2017_Feb22
date=01Mar2022_2017
VAR1=DYfit_Z_bin_Boosted #DYfit_bin_Resolved #mjj_max, DNNoutput_All_years, Zleppt
VAR2=DNNoutput_pruned_bVeto_morebins #try other binnings
CUT=Boosted_DYcr_bVeto
CUTSR=Boosted_SR_bVeto
...
combine -M FitDiagnostics ${cardNameWorkspace}.root --out fit/${VAR2} --robustFit=1 --cminDefaultMinimizerStrategy 0 --rMin -20 --saveWithUncertainties --saveOverallShapes --plots --saveNormalizations -t -1 --expectSignal 0 --toysFreq  #--setParameters mask_${CUTSR}_${VAR2}=1 --toysFile  fit/toys_${VAR2}.root #--toysFreq --expectSignal 0 --robustFit=1
#cd Datacards_${date}
