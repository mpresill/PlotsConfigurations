...
cutsFile = 'cuts_qgl.py'

# file with list of samples
#samplesFile = 'samples_test.py'
samplesFile = 'samples_qgl.py'


# file with list of samples
#plotFile = 'plot_sig.py'
plotFile = 'plot_qgl.py'
...
outputDirDatacard = '/afs/cern.ch/work/a/ahakimi/latinos_NN/PlotsConfigurations/Configurations/VBS_ZV/2017_dec21/Datacards'+date


# structure file for datacard
structureFile = 'structure_qgl.py'

# nuisances file for mkDatacards and for mkShape
nuisancesFile = 'nuisances_qgl.py'
