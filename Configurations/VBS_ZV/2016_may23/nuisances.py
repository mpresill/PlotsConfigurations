...
for sample in mc_common :
    if sample in ["ggWW", "WW","WJets","VgS"]: continue   #,"DY","top" #this sample apparently doesn't have LHE weights, but it's real minor for us
...
for DYbin in range(1,6):
        nuisances["DY_bin{}_norm_res_Z_bVeto_2016".format(DYbin)]  = {
                ...
                'samples'  : {DY_bins[DYbin-1]:res_bVeto_2016[DYbin-1]},
                'type'  : 'rateParam',
                'cuts'  : [
                   'Resolved_DYcr_bVeto',
                   'Resolved_SR_bVeto',
        ...
        nuisances["DY_bin{}_norm_res_Z_bTag_2016".format(DYbin)]  = {
                ...
                'samples'  : {DY_bins[DYbin-1]:res_bTag_2016[DYbin-1]},
                'type'  : 'rateParam',
                'cuts'  : [
                   'Resolved_DYcr_bTag',
                   'Resolved_SR_bTag',
        ...
        nuisances["DY_bin{}_norm_boost_Z_bVeto_2016".format(DYbin)]  = {
                ...
                'samples'  : {DY_bins[DYbin-1]:boos_bVeto_2016[DYbin-1]},
                'type'  : 'rateParam',
                'cuts'  : [
                   'Boosted_DYcr_bVeto',
                   'Boosted_SR_bVeto',
        ...
        nuisances["DY_bin{}_norm_boost_Z_bTag_2016".format(DYbin)]  = {
                ...
                'samples'  : {DY_bins[DYbin-1]:boos_bTag_2016[DYbin-1]},
                'type'  : 'rateParam',
                'cuts'  : [
                   'Boosted_DYcr_bTag',
                   'Boosted_SR_bTag',
