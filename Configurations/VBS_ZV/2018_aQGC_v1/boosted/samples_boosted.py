...
addSampleWeight(samples,'sm','ZTo2L_ZTo2J_dipoleRecoil','(Sum$(abs(GenPart_pdgId)==6)==0)  * (0.01606/0.01589)')
addSampleWeight(samples,'sm','WmTo2J_ZTo2L_dipoleRecoil','(Sum$(abs(GenPart_pdgId)==6)==0) * (0.03004/0.02982)')
addSampleWeight(samples,'sm','WpTo2J_ZTo2L_dipoleRecoil','(Sum$(abs(GenPart_pdgId)==6)==0) * (0.05526/0.05401)')
...
#############  BACKGROUNDS  ###############
###########################################
#####NEW BACKGROUNDS (24/03) -> NOT ADDED IN 2017,2016, SO WON'T ADD IT NOW!
#samples['WGJJ']={
