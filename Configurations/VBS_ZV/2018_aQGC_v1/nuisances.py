...
###########################################
        ...
        #### BUGGY!!!! TO BE UPDATE - 6OCTOBER 2022

##### PS: all these Psweights need to be updated 
samples_PS = ['top','DY','VV','VVV','Vg','VgS','VBF-V','ggWW','VBS_VV_QCD']   #add VBS_QCD_VV when ready on SMP eos

for sample in samples_PS:
    nuisances['PS_ISR'+sample]  = {
                    'name'  : 'PS_ISR'+sample,
                    'kind'  : 'weight',
                    'type'  : 'shape',
                    'samples'  : {
...
for sample in mc_signal+EFT_samples:
    nuisances['PS_ISR_signal']  = {
                    'name'  : 'PS_ISR_signal',
                    'kind'  : 'weight',
                    'type'  : 'shape',
                    'samples'  : {
