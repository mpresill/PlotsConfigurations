...
"""
aliases['cat']={
    'expr': "jets_cat(nCleanJetNotFat, nCleanFatJet, CleanJet_pt, CleanJetNotFat_jetIdx, CleanJet_phi, CleanJet_eta, Jet_mass, CleanJet_jetIdx, CleanFatJet_mass,nLepton, Lepton_eta, CleanFatJet_eta, Jet_qgl, CleanFatJet_jetIdx, Jet_btagDeepB,Lepton_pt, Lepton_phi, 2018)",
    }
...
aliases['nbtag'] = {'expr': 'cat[23]'}
aliases['Zleppt'] = {'expr': 'cat[24]'}
"""
aliases['ptllDYW_NLO'] = {
