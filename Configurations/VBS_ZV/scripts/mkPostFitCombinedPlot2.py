...
class LawnMower:
    ...
    def makePostFitCombinedPlot(self):
        ...
        if self._divideByBinWidth :
          variables_file.write("         'divideByBinWidth': 1,    \n")  
...
'''    
    ...
    parser.add_option('--divideByBinWidth'      , dest='divideByBinWidth'      , help='add a line for divideByBinWidth option in output variable file' , action='store_true', default=False) 
