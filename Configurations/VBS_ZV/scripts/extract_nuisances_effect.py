...
example 1:
python extract_nuisances_effect.py \
    -i /eos/user/m/mpresill/CMS/VBS/VBS_ZV/histograms/rootFile_13Sep2022_2018/plots_VBS_ZV_13Sep2022_2018.root \
        -o test.root -s VBS_VV_QCD -c Boosted_SR_bVeto -v events -n QCDscale_VBS_VV_QCD

example 2 (fitting):
python extract_nuisances_effect.py \
    -i /eos/user/m/mpresill/CMS/VBS/VBS_ZV/histograms/rootFile_13Sep2022_2018/plots_VBS_ZV_13Sep2022_2018.root \
        -o test.root -s VBS_VV_QCD -c Boosted_SR_bVeto -v events -n QCDscale_VBS_VV_QCD -f
