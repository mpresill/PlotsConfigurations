...
example:
python apply_nuisances_effect.py \
    -i /eos/user/m/mpresill/CMS/VBS/VBS_ZV/histograms/rootFile_12Sep2022_2016/plots_VBS_ZV_12Sep2022_2016_boosted.root \
        --nuisance-effect test.root -o out.root -s VBS_VV_QCD -n QCDscale_VBS_VV_QCD
