...
#                card.write('%s group = %s\n' % (group, ' '.join(nuisanceGroups[group])))
              ...
              for nuisance in nuisances.itervalues():
                ...
                if 'group' in nuisance:                                                     ####MATTEO
                  nuisanceGroups[nuisance['group']].append(nuisance['name'])                ####MATTEO
              ...
              for group in sorted(nuisanceGroups.iterkeys()):                               ####MATTEO
                card.write('%s group = %s\n' % (group, ' '.join(nuisanceGroups[group])))    ####MATTEO
