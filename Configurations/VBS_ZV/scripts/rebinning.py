...
FILE ='/eos/user/m/mpresill/CMS/VBS/VBS_ZV/histograms/rootFile_13Jan2023_2017/plots_VBS_ZV_13Jan2023_2017_resolved.root' #mkshape root output to rebin
CUT="Resolved_SR_bVeto" # cut to rebin
VARIABLE="DNNoutput_pruned_bVeto_rebin" # variable to rebin
SAMPLE="sm_dipole" #Sample taht should have equal yields in new bins (usually signal)
NEWFILE='rebin_test2017.root' # name of the rebinned file
...
MAX=10 # max number of bins to test
OUTPUT='test2017'#no extansion
DATACARDDIR='/eos/user/m/mpresill/CMS/VBS/VBS_ZV/Datacards/Datacards_13Jan2023_2017/' #name of repertory for saving rebinned datacards
CONFIGFILE='../2017_Dec/resolved/configuration.py'# config file used to produce FILE
STAT_TEST=False
