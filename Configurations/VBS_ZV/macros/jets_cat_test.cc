...
class jets_cat_test : public multidraw::TTreeFunction {
public:
  jets_cat_test( char const* _type, const char* year);
  jets_cat_test( unsigned type, const char* year);

  char const* getName() const override { return "jets_cat_test"; }
  TTreeFunction* clone() const override { return new jets_cat_test(returnVar_,year_.c_str() ); }
...
std::tuple<UInt_t, UInt_t, ULong64_t> jets_cat_test::currentEvent{};

UIntValueReader* jets_cat_test::nFatJet{}; 
FloatArrayReader* jets_cat_test::FatJet_pt{};
FloatArrayReader* jets_cat_test::FatJet_eta{};
FloatArrayReader* jets_cat_test::FatJet_phi{};
FloatArrayReader* jets_cat_test::FatJet_mass{};


IntArrayReader*   jets_cat_test::CleanJet_jetId{};
IntArrayReader*   jets_cat_test::CleanJetNotFat_jetId{};
FloatArrayReader* jets_cat_test::Jet_mass{};
UIntValueReader*  jets_cat_test::nCleanJetNotFat; 
FloatArrayReader* jets_cat_test::CleanJet_pt{};
FloatArrayReader* jets_cat_test::CleanJet_eta{};
FloatArrayReader* jets_cat_test::CleanJet_phi{};

UIntValueReader* jets_cat_test::nLepton{}; 
FloatArrayReader* jets_cat_test::Lepton_eta{};
...
jets_cat_test::jets_cat_test( char const* _type, const char* year):
   TTreeFunction(){
    ...
    jets_cat_test::year_ = year;

}

jets_cat_test::jets_cat_test( unsigned type, const char* year):
...
void
jets_cat_test::bindTree_(multidraw::FunctionLibrary& _library)
{   
...
/*static*/
void
jets_cat_test::setValues(UInt_t _run, UInt_t _luminosityBlock, ULong64_t _event)
{
