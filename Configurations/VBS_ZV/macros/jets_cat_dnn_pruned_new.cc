...
jets_cat_dnn::setValues(UInt_t _run, UInt_t _luminosityBlock, ULong64_t _event)
{
  ...
  if (njet>=2){
	...
	//cout << "vbs0 idx: " << vbs_jet_0 << " vbs1 idx:" <<vbs_jet_1 << endl; 
        ...
        cout << "v0 idx: " << v_jet_0 << " v1 idx:"<< v_jet_1 << endl;
        }else{
            category = 3;
        }
  ...
  // Now go back to CleanJet indexes for easy use of the collection
    if (category != 3) {
            ...
            cout << "vbs0 pt : " << returnValues[vbs_jet_pt1] << " vbs1 pt:"<< returnValues[vbs_jet_pt2] << endl;
	    ...
	    cout << "v0 pt : " << returnValues[v_jet_pt1] << " v1 pt:"<< returnValues[v_jet_pt2] << endl;
