...
samples['VBS_ZV_aQGC'] = {
    ...
    'weight': mcCommonWeight, #do we have to add reweighting for the different Wilson Coeff.?
    'FilesPerJob': 1
}
addSampleWeight(samples,'VBS_ZV_aQGC','WmTo2J_ZTo2L_aQGC','(Sum$(abs(GenPart_pdgId)==6)==0)')
addSampleWeight(samples,'VBS_ZV_aQGC','WpTo2J_ZTo2L_aQGC','(Sum$(abs(GenPart_pdgId)==6)==0)')
