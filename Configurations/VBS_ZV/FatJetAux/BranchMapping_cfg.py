...
#Clean fat jet uncertainties branches

branch_mapping["pt_jesTotalUp"] = {
  'branches': _Fatjetpt_syst_branches,
  'auxsuffix'   : '_pt_jesTotalUp'
}
branch_mapping["pt_jesTotalDown"] = {
  'branches': _Fatjetpt_syst_branches,
  'auxsuffix'   : '_pt_jesTotalDown'
}

branch_mapping["pt_jerUp"] = {
  'branches': _Fatjetpt_syst_branches,
  'auxsuffix'  : '_pt_jerUp'
}
branch_mapping["pt_jerDown"] = {
  'branches': _Fatjetpt_syst_branches,
  'auxsuffix'  : '_pt_jerDown'
}

#mV uncertainties branches
branch_mapping["jesTotalUp"] = {
  'branches': _mV_syst_branches,
  'auxsuffix'  : '_jesTotalUp'
}
branch_mapping["jesTotalDown"] = {
  'branches': _mV_syst_branches,
  'auxsuffix'  : '_jesTotalDown'
}
branch_mapping["jerUp"] = {
  'branches': _mV_syst_branches,
  'auxsuffix'  : '_jerUp'
}
branch_mapping["jerDown"] = {
  'branches': _mV_syst_branches,
  'auxsuffix'  : '_jerDown'
}
branch_mapping["jmrUp"] = {
  'branches': _mV_syst_branches,
  'auxsuffix'  : '_jmrUp'
}
branch_mapping["jmrDown"] = {
  'branches': _mV_syst_branches,
  'auxsuffix'  : '_jmrDown'
}
branch_mapping["jmsUp"] = {
  'branches': _mV_syst_branches,
  'auxsuffix'  : '_jmsUp'
}
branch_mapping["jmsDown"] = {
  'branches': _mV_syst_branches,
  'auxsuffix'  : '_jmsDown'
}
...
##SUBJETS 
branch_mapping["subjetJERup"] = {
  'branches': _Subjet_syst_branches,
  'suffix': '_subjetJERup'
}

branch_mapping["subjetJERdo"] = {
  'branches': _Subjet_syst_branches,
  'suffix': '_subjetJERdo'
}

branch_mapping["subjetJESup"] = {
  'branches': _Subjet_syst_branches,
  'suffix': '_subjetJESup'
}

branch_mapping["subjetJESdo"] = {
  'branches': _Subjet_syst_branches,
  'suffix': '_subjetJESdo'
}
