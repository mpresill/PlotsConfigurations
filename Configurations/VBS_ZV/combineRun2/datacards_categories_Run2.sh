...
combineCards.py boosted_2016_sr1=${DatacardPATH}/Datacards/Datacards_${Date2016}/Boosted_${cutSR1}/${SR1_var}/datacard.txt \
                ...
                boosted_2018_topcr1=${DatacardPATH}/Datacards/Datacards_${Date2018}/Boosted_topcr/${SR1_var}/datacard.txt  > ${DatacardPATH}/Datacards/YearsCombination_${tag}/combined_boosted_bVeto.txt
...
combineCards.py boosted_2016_sr2=${DatacardPATH}/Datacards/Datacards_${Date2016}/Boosted_${cutSR2}/${SR2_var}/datacard.txt \
                ...
                boosted_2018_topcr2=${DatacardPATH}/Datacards/Datacards_${Date2018}/Boosted_topcr/${SR2_var}/datacard.txt  > ${DatacardPATH}/Datacards/YearsCombination_${tag}/combined_boosted_bTag.txt
...
echo "significance " ${SigPATH}/FullRun2_${tag}/combined_resolved_bVeto.txt 
                ...
                #### B-tag RESOLVED
combineCards.py resolved_2016_sr2=${DatacardPATH}/Datacards/Datacards_${Date2016}/Resolved_${cutSR2}/${SR2_var}/datacard.txt \
